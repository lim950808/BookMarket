...
<nav class="navbar navbar-expand-sm bg-light justify-content-end">
      ...
      <c:choose>
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/BookMarket/Bmember/updateMem.jsp">마이페이지</a>
        </li>
        </c:otherwise>
  	  </c:choose>
        <li class="nav-item">
      ...
      <ul class="navbar-nav">
         <li class="nav-item dropdown" id="mynavbar2-1">
		    ...
		    <ul class="dropdown-menu">
		      <li><a class="dropdown-item" href="BookListAction.do?category='게임'">
		      ...
		      게임</a></li>
		      <li><a class="dropdown-item" href="BookListAction.do?category='프로그래밍 언어'">
		      ...
		      그래픽/디자인/멀티미디어</a></li>
		      <li><a class="dropdown-item" href="BookListAction.do?category='모바일 프로그래밍'">
		      ...
		      프로그래밍 언어</a></li>
		      <li><a class="dropdown-item" href="BookListAction.do?category='오피스 활용'">
		      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-display" viewBox="0 0 16 16">
			  <path d="M0 4s0-2 2-2h12s2 0 2 2v6s0 2-2 2h-4c0 .667.083 1.167.25 1.5H11a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1h.75c.167-.333.25-.833.25-1.5H2s-2 0-2-2V4zm1.398-.855a.758.758 0 0 0-.254.302A1.46 1.46 0 0 0 1 4.01V10c0 .325.078.502.145.602.07.105.17.188.302.254a1.464 1.464 0 0 0 .538.143L2.01 11H14c.325 0 .502-.078.602-.145a.758.758 0 0 0 .254-.302 1.464 1.464 0 0 0 .143-.538L15 9.99V4c0-.325-.078-.502-.145-.602a.757.757 0 0 0-.302-.254A1.46 1.46 0 0 0 13.99 3H2c-.325 0-.502.078-.602.145z"/>
			  </svg>
		      오피스 활용</a></li>
		      <li><a class="dropdown-item" href="BookListAction.do?category='OS/데이터베이스'">
		      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-line" viewBox="0 0 16 16">
			  <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
			  </svg>
		      OS/데이터베이스</a></li>
		      <li><a class="dropdown-item" href="BookListAction.do?category='웹사이트'">
