      ...
      <ul class="navbar-nav">
         <li class="nav-item dropdown" id="mynavbar2-1">
		    ...
		    <ul class="dropdown-menu">
		      <li><a class="dropdown-item" href="list.do?category='게임'">
		      ...
		      게임</a></li>
		      <li><a class="dropdown-item" href="list.do?category='그래픽/디자인/멀티미디어'">
		      ...
		      그래픽/디자인/멀티미디어</a></li>
		      <li><a class="dropdown-item" href="list.do?category='네트워크/해킹/보안'">
        ...
        <li class="nav-item"  id="mynavbar2-2">
          <a class="nav-link text-dark" href="http://localhost:8080/WebMarket_book/welcome.jsp?#best">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/WebMarket_book/welcome.jsp?#new">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/WebMarket_book/welcome.jsp?#recommend">
